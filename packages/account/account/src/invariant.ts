...
/**
 * No runtime invariant: this Service Definition owns request/result types,
 * while the PostgreSQL provider owns durable rows and the HTTP Consumer owns
 * the cookie-visible Sign-in session.
 */
