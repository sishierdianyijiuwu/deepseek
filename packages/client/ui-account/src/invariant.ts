...
/**
 * No runtime invariant: sign-in state lives on the control-plane HTTP
 * cookie, while this package is a slot effect whose registration and
 * teardown are exercised here.
 */
