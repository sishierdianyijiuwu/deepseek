...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/account/account': { kind: 'none', reason: 'Account identity is a control-plane concern and registers nothing model-facing.' },
  'packages/account/account-postgres': { kind: 'none', reason: 'PostgreSQL Account rows never enter a model request.' },
  'packages/account/account-http': { kind: 'none', reason: 'Auth HTTP is a browser-to-control-plane carrier and registers nothing model-facing.' },
  'packages/account/mailer': { kind: 'none', reason: 'Outbound mail never enters a model request.' },
