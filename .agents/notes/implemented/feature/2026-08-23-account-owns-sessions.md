...
Hosted HTTP tests with two cookie jars are the source of truth. Operator access is a separate decision ([Operator read-only access](2026-08-23-operator-readonly-audit.md)). SQLite databases stamped schema 17 no longer open.
